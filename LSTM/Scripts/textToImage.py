...
def convertToImage(filename_complete_path, filename):
        print (filename_complete_path,filename)
        global copy
...
# for z in range(1,50):
convertToImage("../Generated_levels/mario-1-1-edited_trans_new_"+str(z)+"_upRight.csv","mario-1-1-edited_trans_new_"+str(z)+".txt")
    # convertToImage("../Generated_levels/mario-1-1-edited_trans_new_4_upRight.csv","mario-1-1-edited_trans_new_4.txt")
    # convertToImage("../Generated_levels/mario-1-1-edited_trans_new_5_upRight.csv","mario-1-1-edited_trans_new_5.txt")
    # convertToImage("../Generated_levels/mario-1-1-edited_trans_new_6_upRight.csv","mario-1-1-edited_trans_new_6.txt")
