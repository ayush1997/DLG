...
# predicted_level =  "mario-1-1-edited_trans_"
for z in range(1,50):
    predicted_level = sys.argv[1]

    # predicted_level = predicted_level + str(z) + ".txt"
    ...
    convertToImage(new_img_level_folder + csv_pred  +str(z)+ "_upRight.csv", predicted_level_n)